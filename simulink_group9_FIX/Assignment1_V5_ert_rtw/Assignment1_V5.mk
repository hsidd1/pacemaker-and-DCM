...
COMPILER_COMMAND_FILE     = Assignment1_V5_comp.rsp
CMD_FILE                  = Assignment1_V5.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Assignment1_V5.elf
...
%.o : $(START_DIR)/Assignment1_V5_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Assignment1_V5_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Assignment1_V5_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Assignment1_V5_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Assignment1_V5_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/Assignment1_V5_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Assignment1_V5.o : $(START_DIR)/Assignment1_V5_ert_rtw/Assignment1_V5.c
	$(CC) $(CFLAGS) -o "$@" "$<"
