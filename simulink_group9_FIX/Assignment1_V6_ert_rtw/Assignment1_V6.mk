###########################################################################
## Makefile generated for component 'Assignment1_V6'. 
## 
## Makefile     : Assignment1_V6.mk
## Generated on : Fri Dec 01 05:47:55 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Assignment1_V6.elf
...
COMPILER_COMMAND_FILE     = Assignment1_V6_comp.rsp
CMD_FILE                  = Assignment1_V6.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Assignment1_V6.elf
...
DEFINES_ = -DMW_SERIAL0_TXBUF_SIZE=4 -DMW_SERIAL0_RXBUF_SIZE=16 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__
...
OBJS = MW_SCI.o i2c_api.o MW_I2C.o mw_sdk_interface.o MW_digitalIO.o MW_PWM.o MW_AnalogInput.o Assignment1_V6.o Assignment1_V6_data.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o
...
%.o : $(START_DIR)/Assignment1_V6_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Assignment1_V6_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Assignment1_V6_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Assignment1_V6_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Assignment1_V6_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/Assignment1_V6_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Assignment1_V6.o : $(START_DIR)/Assignment1_V6_ert_rtw/Assignment1_V6.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Assignment1_V6_data.o : $(START_DIR)/Assignment1_V6_ert_rtw/Assignment1_V6_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
