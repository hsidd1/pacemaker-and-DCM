###########################################################################
## Makefile generated for component 'Assignment1_V4'. 
## 
## Makefile     : Assignment1_V4.mk
## Generated on : Tue Nov 28 02:39:39 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Assignment1_V4.elf
...
COMPILER_COMMAND_FILE     = Assignment1_V4_comp.rsp
CMD_FILE                  = Assignment1_V4.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Assignment1_V4.elf
...
DEFINES_STANDARD = -DMODEL=Assignment1_V4 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_digitalIO.o mw_sdk_interface.o i2c_api.o MW_I2C.o MW_PWM.o MW_AnalogInput.o Assignment1_V4.o Assignment1_V4_data.o Assignment1_V4_tgtconn.o rtGetInf.o rtGetNaN.o rt_nonfinite.o updown.o ext_work.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o k64f_rtiostream_interface.o k64f_rtiostream_commservice.o k64f_ext_svr.o k64f_rtiostream_utils.o tgtSvc_UARTInfo.o
...
%.o : $(START_DIR)/Assignment1_V4_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Assignment1_V4_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Assignment1_V4_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Assignment1_V4_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Assignment1_V4_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/Assignment1_V4_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Assignment1_V4.o : $(START_DIR)/Assignment1_V4_ert_rtw/Assignment1_V4.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Assignment1_V4_data.o : $(START_DIR)/Assignment1_V4_ert_rtw/Assignment1_V4_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Assignment1_V4_tgtconn.o : $(START_DIR)/Assignment1_V4_ert_rtw/Assignment1_V4_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/Assignment1_V4_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/Assignment1_V4_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/Assignment1_V4_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
