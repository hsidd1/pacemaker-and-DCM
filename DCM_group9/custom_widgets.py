...
class FunkyWidget(tk.Frame):
    def __init__(self, screen, limits: dict, default: float, **kwargs,):
        ...
        self.current_increment, self.current_interval = self.get_increment_interval(self.var.get())
    ...
    def increment_value(self):
        ...
        if (current_value+self.current_increment > self.current_interval[1]):
            self.current_increment, self.current_interval = next_increment, next_interval
