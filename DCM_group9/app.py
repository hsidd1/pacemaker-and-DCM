...
# The current pages geometry - keeps the page from resetting 
# to the top left when moving between screens
page_geometry = "600x500"
...
def welcome_screen() -> None:
    ...
    welcome_page.geometry(page_geometry)
    ...
    def login_user() -> None:
        ...
        page_geometry = welcome_page.geometry()
...
def homepage_screen() -> None:
    ...
    homepage_screen.geometry(page_geometry)
    ...
    bring_to_front(homepage_screen)
...
def settings_screen(pacing_mode: str) -> None:
    ...
    settings_screen.geometry(page_geometry)
    ...
    bring_to_front(settings_screen)        
    ...
    def close():
        ...
        global page_geometry
        page_geometry = settings_screen.geometry()
    ...
    if pacing_mode == "AOO":
        ...
        LowerRate_entry.insert(0, current_user.parameter_dict[pacing_mode]["l_rate_limit"])
        UpperRate_entry.insert(0, current_user.parameter_dict[pacing_mode]["u_rate_limit"])
        AtrialAmp_entry.insert(0, current_user.parameter_dict[pacing_mode]["atrial_amplitude"])
        AtrialPulseWidth_entry.insert(0, current_user.parameter_dict[pacing_mode]["atrial_pulse_width"])
        ...
        LowerRate_entry.insert(0, current_user.parameter_dict[pacing_mode]["l_rate_limit"])
        UpperRate_entry.insert(0, current_user.parameter_dict[pacing_mode]["u_rate_limit"])
        VentricularAmp_entry.insert(0, current_user.parameter_dict[pacing_mode]["vent_amplitude"])
        VentricularPulseWidth_entry.insert(0, current_user.parameter_dict[pacing_mode]["vent_pulse_width"])        
        ...
        VentricularAmp_entry.insert(0, current_user.parameter_dict[pacing_mode]["vent_amplitude"])
        VentricularPulseWidth_entry.insert(0, current_user.parameter_dict[pacing_mode]["vent_pulse_width"])        
        Vrp_entry.insert(0, current_user.parameter_dict[pacing_mode]["VRP"])     
        ...
        AtrialAmp_entry.insert(0, current_user.parameter_dict[pacing_mode]["atrial_amplitude"])
        AtrialPulseWidth_entry.insert(0, current_user.parameter_dict[pacing_mode]["atrial_pulse_width"])
        Arp_entry.insert(0, current_user.parameter_dict[pacing_mode]["ARP"])
